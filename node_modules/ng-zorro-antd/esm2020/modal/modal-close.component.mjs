...
NzModalCloseComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.5", ngImport: i0, type: NzModalCloseComponent, deps: [{ token: i1.ModalOptions }], target: i0.ɵɵFactoryTarget.Component });
